			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<tbody>
						<?php 
							if(isset($_SESSION['products'])){
								$mang=$_SESSION["products"];
								$tong=0; 
								foreach($mang as $value){
									$price = str_replace("$", "", $value["price"]);
									$tonggia = (+$price * $value["qty"]);
									$tong += $tonggia;
						?>		
						<tr>
						    ...
						    <td class="cart_quantity">
						        <div class="cart_quantity_button">
						            <a class="cart_quantity_up" data-id="<?php echo $value['id']; ?>"> + </a>
						            <input class="cart_quantity_input" type="text" name="quantity" value="<?php echo $value['qty']; ?>"	 autocomplete="off" size="2">
						            <a class="cart_quantity_down" data-id="<?php echo $value['id']; ?>"> - </a>

						        </div>
						    </td>
						    <td class="cart_total">
						        <p class="cart_total_price"><?php echo $tonggia; ?></p>
						    </td>
						    <td class="cart_delete">
						        <a class="cart_quantity_delete" data-id="<?php echo $value['id']; ?>"><i class="fa fa-times"></i></a>
						    </td>
						</tr>
						<?php 
						}
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li>Total <span class="aaa"><?php echo $tong; ?>$</span></li>
						</ul>
   ...
   <script type="text/javascript">
    $(document).ready(function(){
        $(".cart_quantity_up").click(function(event){
            ...
            var a=$(this).closest(".cart_quantity_button").find('.cart_quantity_input').val();
            a=parseInt(a)+1;
            $(this).closest(".cart_quantity_button").find(".cart_quantity_input").val(a);
